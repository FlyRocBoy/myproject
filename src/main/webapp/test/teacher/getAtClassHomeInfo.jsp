...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT6-V1.0 T2 获取上课首页信息 </title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getAtClassHomeInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getAtClassHomeInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
