...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT33-V1.0  G8 班级管理-开启/关闭班级</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classId:classId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/changeClassStatus.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('changeClassStatus.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
