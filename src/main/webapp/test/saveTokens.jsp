...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../saveTokens.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">deviceToken:</td>
                    <td><input type="text" name="deviceToken" value="AhBKSnH3Q0Rz7LezplhCyTeO0Krih6N5KAozADYq_gM7"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">deviceType:</td>
                    <td><input type="text" name="deviceType" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">appId:</td>
                    <td><input type="text" name="appId" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('saveTokens.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
