...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT35-V1.0  G8.1 班级管理- 查询教师Id名称列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../tm/getTeacherIdNameList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTeacherIdNameList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
