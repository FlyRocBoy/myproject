...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT47-V1.0 G10.1.1获取学生信息变更明细</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,studentId:studentId,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../stum/getStudentChangeDetail.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getStudentChangeDetail.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
