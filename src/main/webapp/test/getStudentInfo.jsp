...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT46-V1.0 G10.1获取学生信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,studentId:studentId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../stum/getStudentInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="studentId" value="5"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getStudentInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
