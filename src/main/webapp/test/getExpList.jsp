...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT84-V1.1 G14 获取心得提交列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var markType=$("[name=markType]").val();
            var pageNum=$("[name=pageNum]").val();
            var pageSize=$("[name=pageSize]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,trainId:trainId,markType:markType,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../training/getExpList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">markType:</td>
                    <td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getExpList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
