...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT10-V1.0 G3获取教师列表</title>
    <script type="text/javascript" src="../resource/js/jquery-2.1.3.min.js"></script>
    <script type="text/javascript">
        //生成加密串
        function genderSign(methodName){
            var userId=$("[name=userId]").val();
            var searchLoginId=$("[name=searchLoginId]").val();
            var searchUserName=$("[name=searchUserName]").val();
            var pageNum=$("[name=pageNum]").val();
            var pageSize=$("[name=pageSize]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,searchLoginId:searchLoginId,searchUserName:searchUserName,
                pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../tm/getTeacherList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">searchLoginId:</td>
                    <td><input type="text" name="searchLoginId" value="m1@011FX"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">searchUserName:</td>
                    <td><input type="text" name="searchUserName" value="管理员2"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTeacherList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
