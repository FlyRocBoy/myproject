...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT13-V1.0 G3.2 获取教师信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,teacherId:teacherId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../tm/getTeacherInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">teacherId:</td>
                    <td><input type="text" name="teacherId" value="8"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTeacherInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
