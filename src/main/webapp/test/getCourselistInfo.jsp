...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT25-V1.0 G5.2 获取"课程列表"信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,courselistId:courselistId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../clm/getCourselistInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getCourselistInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
