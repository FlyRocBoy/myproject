...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT81-V1.0 获取用户未读通知条数</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../notice/getUnreadCount.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getUnreadCount.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
