...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT65-V1.0  G12.7 积分管理-获取学生积分列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../scorem/getStudentScoreList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="loginId" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getStudentScoreList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
