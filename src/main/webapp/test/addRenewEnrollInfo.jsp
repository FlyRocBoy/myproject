...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT76-V1.0 创建学生续签信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,studentId:studentId,payAmount:payAmount,classIds:classIds,
                time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../em/addRenewEnrollInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="payAmount" value="1.01"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">classIds:</td>
                    <td><input type="text" name="classIds" value="1:2016002001"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addRenewEnrollInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
