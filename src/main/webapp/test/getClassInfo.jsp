...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT38-V1.0 G8.2 获取班级信息</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/getClassInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
