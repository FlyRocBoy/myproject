...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT1-V1.0 T1获取培训首页信息</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getTrainHomeInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTrainHomeInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
