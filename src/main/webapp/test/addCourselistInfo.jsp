...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT24-V1.0 G5.1 创建"课程列表"</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,courselistName:courselistName,subject:subject,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../clm/addCourselistInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="courselistName" value="测试课程列表1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addCourselistInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
