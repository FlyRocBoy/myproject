...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT51-V1.0 G11 通知中心-获取通知列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../notice/getNoticeList.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getNoticeList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
