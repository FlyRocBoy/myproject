...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT15-V1.0 T3.2 获取备课详情</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,plessonId:plessonId,courselistId:courselistId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getPlessonInfo.do" target="ifm_result" method="get">
