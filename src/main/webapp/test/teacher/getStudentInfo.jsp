...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT12-V1.0 T2.3 获取个人信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,studentId:studentId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getStudentInfo.do" target="ifm_result" method="get">
