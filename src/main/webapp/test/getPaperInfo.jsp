...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT82-V1.1 G14.1 批阅心得-获取心得详情</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,paperId:paperId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../training/getPaperInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPaperInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
