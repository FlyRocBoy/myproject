...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT61-V1.0 G12.3.1适用阶段-获取适用阶段信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,phaseId:phaseId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../apm/getPhaseInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="phaseId" value="5"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPhaseInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
