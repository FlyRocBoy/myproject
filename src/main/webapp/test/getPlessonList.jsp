...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT27-V1.0 G6 获取备课列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../plm/getPlessonList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPlessonList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
