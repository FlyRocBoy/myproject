...
<html>
<head>
    <title>   DAYUWEN-APPtoCDS-DYWT11-V1.0 T2.2 获取班级课程信息   </title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,time:time,classId:classId,courseId:courseId};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getClassCourseStudentInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="userId" value="4"/></td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassCourseStudentInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
