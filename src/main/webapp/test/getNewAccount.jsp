...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT6-V1.0 获取新账号</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,schoolId:schoolId,classId:classId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../getNewAccount.do" target="ifm_result" method="GET">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="classId" value="2"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getNewAccount.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
