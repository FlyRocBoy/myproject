...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT20-V1.0 G4.2 获取课程信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,courseId:courseId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../cm/getCourseInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="courseId" value="5"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getCourseInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
