...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT41-V1.0  G8.4 获取班级变更明细</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/getClassModifyDetail.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassModifyDetail.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
