...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT58-V1.0 G12.1.1账号管理-创建管理员</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,schoolId:schoolId,loginId:loginId,
                userName:userName,phoneNum:phoneNum,
                roleId:roleId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../am/addAdminInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="loginId" value="xx"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">userName:</td>
                    <td><input type="text" name="userName" value="阿萨德"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="roleId" value="2"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addAdminInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
