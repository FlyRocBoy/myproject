...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT19-V1.0 删除资源</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var resId=$("[name=resId]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,courseId:courseId,sourceType:sourceType,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../delRes.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">resId:</td>
                    <td><input type="text" name="resId" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('delRes.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
