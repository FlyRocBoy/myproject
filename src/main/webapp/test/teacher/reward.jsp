...
<html>
<head>
    <title>   DAYUWEN-APPtoCDS-DYWT10-V1.0 T2.1  批量/单个发印章   </title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var rewardList=$("[name=rewardList]").val();
            var param={userId:userId,time:time,classId:classId,courseId:courseId,rewardList:rewardList};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/reward.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">rewardList(JSONArray):</td>
                    <td><input type="text" name="rewardList" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('reward.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
