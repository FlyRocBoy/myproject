...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT23-V1.0 G5.1 获取所属科目及适应阶段下的所有课程</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,phaseId:phaseId,subject:subject,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../cm/getCourseListBySubjectPhase.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getCourseListBySubjectPhase.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
