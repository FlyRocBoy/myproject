...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT18-V1.0 T5 修改教师头像</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,courseId:courseId,
                sourceType:sourceType,resTitle:resTitle
                ,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/modifyTeacherHeadImg.do" target="ifm_result" method="post" enctype="multipart/form-data">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('modifyTeacherHeadImg.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
