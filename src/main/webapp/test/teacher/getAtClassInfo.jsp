...
<html>
<head>
    <title> DAYUWEN-APPtoCDS-DYWT8-V1.0 T2.1 获取课堂信息  </title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getAtClassInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getAtClassInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
