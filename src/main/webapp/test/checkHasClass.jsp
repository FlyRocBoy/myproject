...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT79-V1.0 G9招生管理-获取当前用户所在分校下是否存在班级</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../em/checkHasClass.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('checkHasClass.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
