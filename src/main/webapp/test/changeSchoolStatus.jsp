...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT4-V1.0 G2 开启/关闭分校</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,schoolId:schoolId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../sm/changeSchoolStatus.do" target="ifm_result" method="post">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>DAYUWEN-APPtoCDS-DYWHT4-V1.0 G2 开启/关闭分校</h3></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('changeSchoolStatus.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
