...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT66-V1.0 G12.7 积分管理-修改学生积分</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var reson=$("[name=reson]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,studentId:studentId,score:score,
                reson:reson,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../scorem/modifyStudentScore.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="studentId" value="67"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width:150px">reson:</td>
                    <td><input type="text" name="reson" value="我想给你添加100积分"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('modifyStudentScore.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
