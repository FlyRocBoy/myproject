...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT49-V1.0 重置密码</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,targetUserId:targetUserId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../am/resetPwd.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('resetPwd.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
