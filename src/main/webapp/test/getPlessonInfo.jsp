...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT30-V1.0 G6.2 获取备课信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,plessonId:plessonId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../plm/getPlessonInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="plessonId" value="5"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPlessonInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
