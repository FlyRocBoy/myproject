...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT78-V1.0 G12.1.1账号管理-修改管理员状态</title>
    <script type="text/javascript" src="../resource/js/jquery-2.1.3.min.js"></script>
    <script type="text/javascript">
        //生成加密串
        function genderSign(methodName){
            var userId=$("[name=userId]").val();
            var targetUserId=$("[name=targetUserId]").val();
            var status=$("[name=status]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,targetUserId:targetUserId,status:status,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../am/modifyAdminStatus.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">targetUserId:</td>
                    <td><input type="text" name="targetUserId" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('modifyAdminStatus.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
