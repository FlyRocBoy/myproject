...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT57-V1.0 12.1.1账号管理-获取角色列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,schoolId:schoolId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../am/getRoleList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getRoleList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
