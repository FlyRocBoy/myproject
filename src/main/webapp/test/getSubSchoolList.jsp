...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT71-V1.0  G13 校区管理-获取校区列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../subsm/getSubSchoolList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getSubSchoolList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
