...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT62-V1.0  G12.3.1适用阶段-修改适用阶段</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,phaseId:phaseId,phaseName:phaseName,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../apm/modifyPhaseInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="phaseDesc" value="我是修改的描述"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('modifyPhaseInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
