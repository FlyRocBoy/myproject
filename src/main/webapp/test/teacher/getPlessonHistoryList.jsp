...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT14-V1.0 T3.1 获取历史备课列表 </title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getPlessonHistoryList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPlessonHistoryList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
