...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT12-V1.0 G3.1 添加教师</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var teacherLoginId=$("[name=teacherLoginId]").val();
            ...
            var param={userId:userId,teacherName:teacherName,
                phoneNum:phoneNum,idNum:idNum,
                teacherCERTNum:teacherCERTNum,
                workCertSignDate:workCertSignDate,
                workCertNum:workCertNum,
                sex:sex,teacherLoginId:teacherLoginId,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../tm/addTeacher.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">teacherName:</td>
                    <td><input type="text" name="teacherName" value="教师1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width:150px">teacherLoginId:</td>
                    <td><input type="text" name="teacherLoginId" value=""/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addTeacher.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
