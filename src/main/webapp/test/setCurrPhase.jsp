...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT85-V1.1 G12.3 设置/取消当期适用阶段</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,phaseId:phaseId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../	apm/setCurrPhase.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('setCurrPhase.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
