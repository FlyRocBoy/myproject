...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT36-V1.0  G8.1 班级管理- 查询教室Id名称列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,subSchoolId:subSchoolId,schoolId:schoolId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../crm/getClassroomIdNameList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassroomIdNameList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
