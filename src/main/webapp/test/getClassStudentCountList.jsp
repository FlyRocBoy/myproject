...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT63-V1.0 G12.5 班级人数管理-获取班级人数列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classId:classId,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/getClassStudentCountList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassStudentCountList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
