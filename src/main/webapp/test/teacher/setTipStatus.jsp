...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT3-V1.0 T1 设置提醒状态</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var tipType=$("[name=tipType]").val();
            var param={userId:userId,time:time,tipType:tipType};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/setTipStatus.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">tipType:</td>
                    <td><input type="text" name="tipType" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('setTipStatus.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
