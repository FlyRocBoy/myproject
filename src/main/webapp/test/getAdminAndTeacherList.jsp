...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT56-V1.0 G12.1  账号管理-获取账户(含管理员和教师)列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,loginId:loginId,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../am/getAdminAndTeacherList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="loginId" value="t9@010FX5"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getAdminAndTeacherList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
