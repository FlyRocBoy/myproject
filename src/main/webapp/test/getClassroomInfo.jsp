...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT69-V1.0 G12.4.1 教室管理-获取教室信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classroomId:classroomId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../crm/getClassroomInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassroomInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
