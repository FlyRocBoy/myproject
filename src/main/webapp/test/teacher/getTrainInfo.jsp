...
<html>
<head>
    <title> DAYUWEN-APPtoCDS-DYWT5-V1.0 T1.1 获取培训详情 </title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,time:time,trainId:trainId};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getTrainInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTrainInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
