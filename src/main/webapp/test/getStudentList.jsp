...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT45-V1.0 G10 学生管理-获取学生列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../stum/getStudentList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getStudentList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
