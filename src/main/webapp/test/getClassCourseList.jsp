...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT43-V1.0 G9.1 招生管理-获取课程表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classIds:classIds,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../em/getClassCourseList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="classIds" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassCourseList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
