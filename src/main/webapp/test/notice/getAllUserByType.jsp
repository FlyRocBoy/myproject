...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT77-V1.0 G11.1 通知中心-获取通过所有管理员/教师/学生</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../notice/getAllUserByType.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getAllUserByType.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
