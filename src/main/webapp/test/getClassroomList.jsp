...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT67-V1.0  G12.4 教室管理-获取教室列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../crm/getClassroomList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassroomList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
