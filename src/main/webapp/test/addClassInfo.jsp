...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT37-V1.0 G8.1 创建班级</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,className:className,phaseId:phaseId,
                schoolId:schoolId,subSchoolId:subSchoolId,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/addClassInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="className" value="测试班级1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="courseList" value="[{&#34;courseId&#34;:1,&#34;courseStartTime&#34;:&#34;2016-01-01 12:12&#34;,&#34;courseEndTime&#34;:&#34;2016-01-01 12:12&#34;,&#34;teacherId&#34;:19,&#34;classroomId&#34;:1,&#34;orderNum&#34;:1}]"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addClassInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
