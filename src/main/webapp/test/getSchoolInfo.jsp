...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT8-V1.0  G2.2获取分校信息</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../sm/getSchoolInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getSchoolInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
