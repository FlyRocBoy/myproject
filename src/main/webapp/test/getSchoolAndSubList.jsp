...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT11-V1.0 获取分校校区列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,type:type,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../sm/getSchoolAndSubList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                <tr>
                    <td colspan="3" align="center"><h3>DAYUWEN-APPtoCDS-DYWHT11-V1.0 获取分校校区列表</h3></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getSchoolAndSubList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
