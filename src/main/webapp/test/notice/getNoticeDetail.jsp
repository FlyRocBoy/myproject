...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT53-V1.0 G11.2 通知中心-获取通知详情</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,noticeId:noticeId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../notice/getNoticeInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">noticeId:</td>
                    <td><input type="text" name="noticeId" value=""/></td>
                    <td style="width:250px"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getNoticeInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
