...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT40-V1.0 G8.3 获取班级成员列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classId:classId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/getClassmatelist.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassmatelist.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
