...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../cm/getAllCourseIdNamwList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">useFor:</td>
                    <td>
                        <select name="useFor">
                ...
                <tr>
                    ...
                    <td><input type="text" name="subject" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getAllCourseIdNamwList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
