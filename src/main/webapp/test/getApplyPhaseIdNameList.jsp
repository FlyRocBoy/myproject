...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT16-V1.0 获得适应性阶段列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../apm/getApplyPhaseIdNameList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getApplyPhaseIdNameList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
