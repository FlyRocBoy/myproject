...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT73-V1.0 G13 校区管理-获取校区信息</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,subSchoolId:subSchoolId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../subsm/getSubSchoolInfo.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getSubSchoolInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
