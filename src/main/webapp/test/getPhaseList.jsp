...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT59-V1.0 G12.3适用阶段-获取适用阶段列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../apm/getPhaseList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getPhaseList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
