...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWT2-V1.0 T1 获取提醒状态</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../../t/getTipStatus.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getTipStatus.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
