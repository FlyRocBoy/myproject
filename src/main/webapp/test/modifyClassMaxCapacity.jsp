...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT64-V1.0 G12.5 班级人数管理-修改班级最大人数</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var classMaxCapacity=$("[name=classMaxCapacity]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,classId:classId,
                classMaxCapacity:classMaxCapacity,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/modifyClassMaxCapacity.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">classMaxCapacity:</td>
                    <td><input type="text" name="classMaxCapacity" value="100"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('modifyClassMaxCapacity.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
