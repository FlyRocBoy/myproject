...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT22-V1.0 G5 获取"课程列表"列表</title>
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../clm/getCourselistList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getCourselistList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
