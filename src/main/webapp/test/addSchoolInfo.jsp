...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT7-V1.0 G2.1 创建分校</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var adminLoginId=$("[name=adminLoginId]").val();
            var isCheck=$("[name=isCheck]").val();
            var time=$("#txt_s_time").val();
            var param={userId:userId,schoolName:schoolName,relatePersonName:relatePersonName,
                phoneNum:phoneNum,schoolPhoneNum:schoolPhoneNum,
                schoolCode:schoolCode,address:address,
                schoolType:schoolType,provinceId:provinceId,
                cityId:cityId,adminLoginId:adminLoginId,
                isCheck:isCheck,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../sm/addSchoolInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="schoolCode" value="010FX"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td style="width:150px">adminLoginId:</td>
                    <td><input type="text" name="adminLoginId" value="m1@010FX"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td style="width:150px">isCheck:</td>
                    <td>
                        <select  name="isCheck">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addSchoolInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
