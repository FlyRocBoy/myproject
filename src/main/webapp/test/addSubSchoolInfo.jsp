...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT72-V1.0  G13 校区管理-创建校区</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,subSchoolName:subSchoolName,relatePersonName:relatePersonName,
                phoneNum:phoneNum,subSchoolPhoneNum:subSchoolPhoneNum,address:address,provinceId:provinceId,
                cityId:cityId,adminLoginId:adminLoginId,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../subsm/addSubSchoolInfo.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="userId" value="13"/></td>
                ...
                <tr>
                    ...
                    <td><input type="text" name="relatePersonName" value="校区管理员1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" name="adminLoginId" value="m1@010FX10"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                    <td>time:</td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addSubSchoolInfo.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
