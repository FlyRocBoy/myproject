...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT68-V1.0 G12.4.1 教室管理-创建教室</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,schoolId:schoolId,subSchoolId:subSchoolId,classroomName:classroomName,
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../crm/addClassroom.do" target="ifm_result" method="post">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('addClassroom.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
