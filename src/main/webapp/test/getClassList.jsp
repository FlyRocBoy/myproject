...
<html>
<head>
    <title>DAYUWEN-APPtoCDS-DYWHT32-V1.0  G8 班级管理-获取班级列表</title>
    ...
    <script type="text/javascript">
        ...
        function genderSign(methodName){
            ...
            var param={userId:userId,classId:classId,className:className,pageNum:pageNum,pageSize:pageSize,time:time};
...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../classm/getClassList.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    ...
                    <td><input type="text" name="className" value="1"/></td>
                    <td style="width:250px"></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('getClassList.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
