...
<div id="dv_xuanxiang">
    <div id="add" align="center">
        <form action="../checkVersion.do" target="ifm_result" method="get">
            <table style="width:650px;">
                ...
                <tr>
                    <td style="width:150px">versionCode:</td>
                    <td><input type="text" name="versionCode" value="1"/></td>
                ...
                <tr>
                    ...
                    <td><input type="button" value="生成" onclick="genderSign('checkVersion.do')"/>
                    </td>
                </tr>
                <tr>
                <tr>
